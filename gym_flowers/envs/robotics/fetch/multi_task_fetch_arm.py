...
from gym_flowers.envs.robotics import multi_task_fetch_arm_v0, multi_task_fetch_arm_v1, multi_task_fetch_arm_v2, multi_task_fetch_arm_v3, multi_task_fetch_arm_v4, multi_task_fetch_arm_v5
...
class MultiTaskFetchArmV5(multi_task_fetch_arm_v5.MultiTaskFetchArmV5, utils.EzPickle):
    def __init__(self, reward_type='sparse', tasks=[0,1,2,3,4,5,6,7], n_distractors=1):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
