...
class Rooms5():
    def __init__(self, reward_type='sparse', nb_rooms=5, distance_threshold=16, debug=False):
        ...
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        ...
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000111111111111111",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000201",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        ...
        #     "1000000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1020000000000000000000000000100000000000001",
        #     "1000000000000000000000000000100000000000001",
        #     "1111111111111111111111111111111111111111111",
        #     "1000000000000010000000000000100000000000001",
        #     "1000000000000010000000000020100000000000001",
        #     "1000000000000010000000000000100000000000001",
        #     "1000000000000010000000000000100000000000001",
        #     "1000000000000010000000000000100000000000001",
        #     "1000000000000010000000000000100000000000001",
        ...
        #     "1000000000000010000000000000100000000000001",
        #     "1000000000000010000000000000100000000000001",
        #     "1000000000002010000000000000100000000000201",
        #     "1000000000000010000000000000100000000000001",
        #     "1111111111111111111111111111111111111111111"]
    ...
    def _get_obs(self):
        ...
        if self.agent_pos[1] >= 20 * self.scale: #28
            if self.agent_pos[0] < 10* self.scale: #14
                self.in_rooms[0] = 1
            elif self.agent_pos[0] < 20* self.scale:#28
                self.in_rooms[1] = 1
            else:
                self.in_rooms[2] = 1
        elif self.agent_pos[0] > 21* self.scale: #29
            if self.agent_pos[1] < 10* self.scale:#14
                self.in_rooms[4] = 1
            else:
                self.in_rooms[3] = 1
